...
const navItems = [
  ...
  { to: '/', label: 'Logout', icon: '↪', end: true, danger: true },
];
        ...
        <nav className="student-sidebar-nav">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) => `student-sidebar-link${isActive ? ' active' : ''}${item.danger ? ' is-danger' : ''}`}
              title={item.label}
            >
